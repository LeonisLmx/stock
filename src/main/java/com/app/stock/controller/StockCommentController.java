...
public class StockCommentController {
    ...
    public Response getComment(@RequestBody Map<String,Object> requestMap,HttpServletRequest request){
        return Response.ok(stockCommentService.getComment(requestMap.get("type") == null?1:Integer.valueOf(requestMap.get("type") + ""),
                requestMap.get("stockCode") == null?null:requestMap.get("stockCode").toString(),
                requestMap.get("stockMarket") == null?null:requestMap.get("stockMarket").toString(),
